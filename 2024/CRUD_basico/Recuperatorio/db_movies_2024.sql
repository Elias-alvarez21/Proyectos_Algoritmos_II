...
INSERT INTO movies (title, director, release_year, genre, synopsis, main_actors, rating, user_id_update) VALUES (
                    'TESTING', 'DIRECTOR', 2000, 'Horror', '', '',  7.7, 9);

UPDATE movies SET title = 'TESTING', director = 'DIRECTOR', release_year = 2000, genre = 'Horror', synopsis = '', main_actors = '', rating = 8.8, user_id_update = 5 WHERE id = ?;

UPDATE movies SET enabled = IF(enabled = 1, 0, 1) WHERE id = ?;
